...
public class CheckPayeeDetails extends LoadableComponent<CheckPayeeDetails> {
    private WebDriver driver;
    boolean isFailedFirstTime;

    @FindBy(css = "#C5__C4__EDGE_CONNECT_PROCESS")
    ...
    @FindBy(css = "input[name*='C5__C4__SCREENELEMENTS[1].PAYMENTORDERINPUT[1].BENEFICIARYIBAN_READONLY']")
	...
	public CheckPayeeDetails(WebDriver driver) {
        this.driver = driver;
    ...
    public void clickingTermsCondition() throws Exception{
    ...
    public CheckPayeeDetails verifyPaymentDetail(String tcId) throws Exception {
    ...
    public CheckPayeeDetails verifyPaymentDetailSwiftBic(String tcId) throws Exception {
    	TestDataExtractor tde = new TestDataExtractor("Payments");
    	HashMap<String, String> values = tde.readData(tcId);
    	 if(accountNumer.getAttribute("value").equalsIgnoreCase(values.get("account_number_from")))
    	 {
    ...
    public void verifyPaymentDetailNCC(String tcId) throws Exception {
    	TestDataExtractor tde = new TestDataExtractor("Payments");
    	HashMap<String, String> values = tde.readData(tcId);
    	 if(accountNumer.getAttribute("value").equalsIgnoreCase(values.get("account_number_from")))
    	 {
