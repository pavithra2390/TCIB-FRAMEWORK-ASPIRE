...
public class SavingsAccountApplicationForm extends
		LoadableComponent<SavingsAccountApplicationForm> {
	...
	public SavingsAccountApplicationForm(WebDriver driver) {
		this.driver = driver;
	...
	protected void isLoaded() throws Error {
		if (!isFailedFirstTime && !WaitUtil.waitForElement(driver, pageTitle)) {
			...
			Log.fail("Not navigated to Savings Account Application Form page!",
					driver);
		} else {
			Log.message("Navigated to Savings Account Application Form page!",
					driver);
		}
	}
